...
// Route-level Suspense fallback for the /analytics segment. Renders instantly during the
// route transition (the page chunk download/compile on first visit, and the bare-/analytics
// → /analytics/operations redirect), before any page component has mounted. Without this,
// the first navigation shows a blank screen because the in-page `loading` skeleton lives
// inside the component that is still being fetched. Mirrors the operations shell so the
// sidebar/header don't flash.
