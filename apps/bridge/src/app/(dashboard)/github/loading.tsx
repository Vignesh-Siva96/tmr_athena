...
// Content-only Suspense fallback for /github — the sidebar + outer flex come from
// (dashboard)/layout.tsx, so this paints just the content slot during the route transition so
// the previous page doesn't linger. Mirrors the content (header + stats row + split pane).
